---
name: aaplot
description: Renders terminal charts (bar, line, area, scatter, histogram, count, boxplot, density) from JSON data. Use when the user needs to visualize data in the terminal, create charts from BigQuery output, plot CSV/JSON data, or generate quick data visualizations without leaving the command line.
